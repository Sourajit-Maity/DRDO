...
@section('plugins.Datatables', true)
    ...
    <div class="form-group col-md-6">
            ...
            <div class="form-group col-md-6"; align="right">
                <a class="btn btn-success" href="{{ route('add-banks') }}"><i class="fas fa-plus-square"></i></a>
            </div>
            ...
            <div class="table-responsive">
                ...
                <table id="myTable" class="table table-bordered table-striped {{ count($type) > 0 ? 'datatable' : '' }} pointer">
                    ...
                    <tr>
                        ...
                        <th> Bank Name<p>(बैंक का नाम)</p></th>
                        <th> Bank IFSC No.<p>(बैंक IFSC नंबर)</p></th>
                        <th> Branch Name<p>(शाखा का नाम)</p></th>
                    ...
                    @if (count($type) > 0)
                        @foreach ($type as $user)
                            <tr data-entry-id="{{ $user->id }}">
                                ...
                                <td>{{ $user->bank_ifsc_no }}</td>
                                <td>{{ $user->branch_name }}</td>

                                
                             <td> <a href="{{ route('edit-banks',[$user->id]) }}" class="btn btn-xs btn-info">
                                        ...
                                        <div class="modal-dialog modal-sm">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <a href="{{route('deletebanks',['id'=>$user->id])}}" class="btn btn-xs btn-info"><i class="fa fa-trash fa-lg" aria-hidden="true"></i>
                                                        Delete</a>
                                                </div>
                                            </div>
                                        </div>
