...
@section('plugins.Datatables', true)
    ...
    <div class="form-group col-md-6">
                <h2>Leave Travel Concession Type</h2>
            </div>
            <div class="form-group col-md-6"; align="right">
                <a class="btn btn-success" href="{{ route('add-leave-travel-concession-type') }}"><i class="fas fa-plus-square"></i></a>
            </div>
            ...
            <div class="table-responsive">
                ...
                <table id="myTable" class="table table-bordered table-striped {{ count($type) > 0 ? 'datatable' : '' }} pointer">
                    ...
                    <tr>
                        ...
                        <th> Leave Travel Concession Type Name<p>(अवकाश यात्रा रियायत प्रकार का नाम)</p></th>
                    ...
                    @if (count($type) > 0)
                        @foreach ($type as $user)
                            <tr data-entry-id="{{ $user->id }}">
                                ...
                                <td>{{ $user->leave_travel_concession }}</td>

                                
                             <td> <a href="{{ route('edit-leave-travel-concession-type',[$user->id]) }}" class="btn btn-xs btn-info">
                                        ...
                                        <div class="modal-dialog modal-sm">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <a href="{{route('delete-leave-travel-concession-type',['id'=>$user->id])}}" class="btn btn-xs btn-info"><i class="fa fa-trash fa-lg" aria-hidden="true"></i>
                                                        Delete</a>
                                                </div>
                                            </div>
                                        </div>
