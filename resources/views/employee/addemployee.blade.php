...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="PUT" action="{{ route('submit_employee') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select  name="emp_smoker" id="emp_smoker" class="form-control @error('emp_smoker') is-invalid @enderror" name="emp_smoker" value="{{ old('emp_smoker') }}" required autocomplete="emp_smoker">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="ethnic_race_code" type="text" class="form-control @error('ethnic_race_code') is-invalid @enderror" name="ethnic_race_code" value="{{ old('ethnic_race_code') }}" required autocomplete="ethnic_race_code" autofocus>
   ...
   name="operational_company_id" value="{{ old('operational_company_id') }}" required autocomplete="operational_company_id">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="state_code" type="text" class="form-control @error('state_code') is-invalid @enderror" name="state_code" value="{{ old('state_code') }}" required autocomplete="state_code" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="district_code" type="text" class="form-control @error('district_code') is-invalid @enderror" name="district_code" value="{{ old('district_code') }}" required autocomplete="district_code" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="emp_hm_telephone" type="text" class="form-control @error('emp_hm_telephone') is-invalid @enderror" name="emp_hm_telephone" value="{{ old('emp_hm_telephone') }}" required autocomplete="emp_hm_telephone" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="emp_mobile" type="text" class="form-control @error('emp_mobile') is-invalid @enderror" name="emp_mobile" value="{{ old('emp_mobile') }}" required autocomplete="emp_mobile" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="emp_work_telephone" type="text" class="form-control @error('emp_work_telephone') is-invalid @enderror" name="emp_work_telephone" value="{{ old('emp_work_telephone') }}" required autocomplete="emp_work_telephone" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="sal_grd_code" type="text" class="form-control @error('sal_grd_code') is-invalid @enderror" name="sal_grd_code" value="{{ old('sal_grd_code') }}" required autocomplete="sal_grd_code">
